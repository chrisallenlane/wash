...
$(document).ready(function() {
    ...
    if(wash.permastore.storage.connections.length > 0){
    ...
    // attach events to the editor controls
    $('#editor_save').click(function(){ shell.editor.save(); });
    $('#editor_cancel').click(function(){ shell.editor.cancel(); });
