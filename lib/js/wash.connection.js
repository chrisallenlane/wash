...
wash.connection = {
    ...
    choose: function(){
        ...
        var html = '<p>Choose a Connection. Hover for Details:</p>';
    ...
    chosen: function(args){
        ...
        var connection = con.protocol + '://' + con.domain + ':' + con.port + con.url;
    ...
    load: function(args){
        ...
        if(con != null){
            ...
            shell.elements.url.val(con.domain + con.url);
