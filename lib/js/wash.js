    ...
    process: function(command){
        ...
        // if the prompt is not in wash mode...
            ...
            if(shell.prompt.mode.get() === 'remap'){
                ...
                // payload.
                if(command === false){
                    var context = (wash.response.prompt_context === undefined) ? 'wash$' : wash.response.prompt_context;
            ...
            wash.net.send(function(){  
                ...
                */
                ...
                else { shell.output.write(wash.response.output, 'output ' + wash.command_root); }
            });
        }
    },
};
