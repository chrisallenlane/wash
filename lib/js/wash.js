...
var wash = {
    ...
    process: function(command){
        ...
        // if the prompt is not in wash mode, default to shell action
            ...
            if(space_pos === -1){ var command_post_proc_handle = command; }
            else { var command_post_proc_handle = command.substr(0, space_pos); }
            ...
            wash.net.send(function(){  
                ...
                if(wash.post_processor[command_post_proc_handle] != null){
                    wash.post_processor[command_post_proc_handle]();
                }
                ...
                else { shell.output.write(wash.response.output, 'output ' + command_post_proc_handle); }
            });
        }
    },
}
